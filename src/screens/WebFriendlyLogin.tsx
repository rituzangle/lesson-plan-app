...
export const WebFriendlyLogin: React.FC<WebFriendlyLoginProps> = ({ navigation }) => {
  ...
  const handleQuickLogin = (userType: 'teacher' | 'demo' | 'claudette') => {
    if (userType === 'teacher') {
      setEmail('misskate@school.edu');
      setPassword('jazzy&1taz');
    } else if (userType === 'claudette') {
      setEmail('claudette@demo.com');
      ...
      <View style={[styles.loginCard, { width: containerWidth }]}>
        ...
        <View style={styles.quickLoginSection}>
          ...
          <View style={styles.quickButtonsRow}>
            ...
            <TouchableOpacity
              style={[styles.quickButton, styles.claudetteButton]}
              onPress={() => handleQuickLogin('claudette')}
            >
              <Text style={styles.quickButtonText}>🎭 Claudette</Text>
            </TouchableOpacity>
            <TouchableOpacity
