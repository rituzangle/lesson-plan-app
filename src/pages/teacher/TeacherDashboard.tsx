      ...
      <View style={styles.card}>
        ...
        <View style={styles.grid}>
          <View style={[styles.gridItem, styles.blueBg]}>
            ...
            <Text style={styles.gridItemText}>View and manage your classes</Text>
          </View>
          <View style={[styles.gridItem, styles.greenBg]}>
            <Text style={styles.gridItemTitle}>Lesson Plans</Text>
            <Text style={styles.gridItemText}>Create and edit lesson plans</Text>
          </View>
          <View style={[styles.gridItem, styles.yellowBg]}>
            <Text style={styles.gridItemTitle}>Assignments</Text>
            <Text style={styles.gridItemText}>Track student progress</Text>
          </View>
          <View style={[styles.gridItem, styles.purpleBg]}>
            <Text style={styles.gridItemTitle}>Resources</Text>
            <Text style={styles.gridItemText}>Access teaching materials</Text>
          </View>
        </View>
      </View>
    </View>
